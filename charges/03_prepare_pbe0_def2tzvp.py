...
METHOD_DIR = OUT_DIR / "PBE0_def2TZVP"
...
def main():
    for label in STRUCTURE_SETS:
        for state in ("RS","TS","PS"):
            ...
            input_file = state_dir / "input" / f"{label}_{state}_PBE0_def2TZVP_SP.inp"
            write_input(input_file, "PBE0 D3BJ def2-TZVP SP TightSCF", geometry)
            (state_dir/"README.txt").write_text(
                ...
                encoding="utf-8")
    print(f"Prepared PBE0_def2TZVP jobs in {METHOD_DIR}")
